...
assert(
  ...
  "admin:update-local debe aplicar migraciones, importar contenido, purgar transitorios y assets físicos huérfanos, y terminar con el preflight completo sin recrear propietario ni contraseña."
);
assert(
