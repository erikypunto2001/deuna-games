...
assert(
  ...
  "admin:update-local debe aplicar migraciones, importar contenido, diagnosticar residuos sin borrarlos y terminar con el preflight completo, sin recrear propietario ni contraseña."
);
assert(
