...
try {
  ...
  console.log(
    "Higiene editorial PostgreSQL: OK (mínimo privilegio, bloqueo de fuente/visibilidad/Home, borrado coordinado, cola multimedia durable, bloqueo de reutilización, limpieza de snapshots e historial preservando estado actual)."
  );
} catch (error) {
