...
import { hideSoftwarePublication } from "@/lib/admin/visibility-service";
...
export async function POST(
  ...
  const target = "/admin/programas/" + encodeURIComponent(slug);
  ...
  try {
    const result = await hideSoftwarePublication(
      slug,
      expected.data,
    ...
    console.error("No se pudo ocultar el programa.");
